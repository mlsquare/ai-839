...
3. Model diagnostics of LLMs: Application Random Matrix Theory (RMT) to assess model generalization ability
    - Implicit Self-Regularization in Deep Neural Networks: Evidence from Random Matrix Theory and Implications for Learning [paper](https://jmlr.org/papers/v22/20-410.html)
    ...
    - Application of RMT to analyse a LSA (Latent Semantic Analysis) model [notebook](https://github.com/CalculatedContent/WeightWatcher/blob/master/examples/LSA.ipynb)
...
3. \[video\] [Heavy Tails in ML: Structures, Stability Dynamics](https://nips.cc/virtual/2023/83033) Invited talks at NeurIPS'23
