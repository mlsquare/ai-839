...
3. CP is model-agnostic and can work for a variety of tasks including, regression, multi-class classification, multi-label prediction, time-series models, and also in LLMs [Conformal Language Modeling](https://arxiv.org/abs/2306.10193)
