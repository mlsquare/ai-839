...
- Using [pymfe](https://github.com/ealcobaca/pymfe), include some useful properties of the dataset in the Data Card Make sure that when any changes in the dataset get reflected automatically and the Data Card is updated automatically. Specifically, if the dataset id 1023 refers to its version v2 
- The [CLeAR](https://shorensteincenter.org/clear-documentation-framework-ai-transparency-recommendations-practitioners-context-policymakers/) has some really nice goals for a document to be 1) comparable 2) legible 3) actionable and 4) robust - to achieve an aspect of AI Transparency. Here we are talking about documenting Data, Models, and AI Systems.
