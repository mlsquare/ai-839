...
| 03 | 13-Aug <br> 16-Aug | **Tutorials** <br> 1. kedro   <br>  2. DevOps  | [W03-L01](./lectures/w03-l01.qmd) <br> Git, Docker, k8s, Git actions |
...
| Wk | Dt | Topics | Resources |
| :- | :- | :------- | :------- |
| 03 | 16-Aug |  Intro to DevOps <br> [ML Engineering]  | [Ravi](https://www.linkedin.com/in/ravismula/) <br> Architect: [Sanketika](https://sanketika.in/) |
| 13 | 08-Nov | Building LLMs in Production in Regulated Industry <br> [System Design] | [Venkata Pingali](https://www.linkedin.com/in/pingali/) <br> Co-Founder: [Scribble Data](https://www.scribbledata.io/) |
